/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/src/worker-configuration.d.ts` (hash: 0f541a2726625cfd051b148fbfee47a4)
