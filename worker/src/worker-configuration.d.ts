/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/src/worker-configuration.d.ts` (hash: 5b8bbb7a32522f7682364de15be84809)
// Runtime types generated with workerd@1.20260722.1 2026-07-26 nodejs_compat
interface __BaseEnv_Env {
	WALLPAPERS: KVNamespace;
	CUSTOM_BACKGROUNDS: R2Bucket;
