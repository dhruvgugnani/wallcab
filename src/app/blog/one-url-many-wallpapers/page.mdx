...
Personal notes change that final step. The renderer escapes and bounds the
text, then returns the personalized image directly without putting that final
PNG in the shared Worker cache. The daily lesson and background can still use
their ordinary active-day caches.
