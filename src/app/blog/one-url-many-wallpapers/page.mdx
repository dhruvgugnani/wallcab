...
Eight learning categories, eight themes, and three screen sizes produce 192 possible daily images. That does not mean 192 different lessons. The selected interest set and UTC date resolve one category; theme and size affect only its presentation.
